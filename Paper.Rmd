---
title: "How Does the Carney Administration’s Abolition of the Carbon Tax Affect Gasoline Prices and Consumption, and How Does the Adjustments Shape Transportation Emissions?"
...
3. How dose the change in gasoline prices and consumption affect the greenhouse emission in road transpiration sector specifically ?
...
### Sales_Quant Model --- Specification
```{=latex}
\[
\begin{aligned}
\log(\text{Sales}_{t,p}) 
...
Overall, the model demonstrates that (1) gasoline prices exhibit strong temporal dependence, (2) both carbon taxation and crude oil prices exert economically meaningful upward pressure on retail fuel prices, and (3) CPI-gasoline captures additional cost-of-living dynamics not explained by tax or crude price changes. These results confirm that the ARIMAX framework successfully separates the structural drivers of gasoline prices from their inherent time-series persistence.
